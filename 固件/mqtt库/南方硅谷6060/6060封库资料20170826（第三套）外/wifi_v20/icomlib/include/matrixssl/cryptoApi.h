...
PSPUBLIC int32 pkcs1ParsePrivFile(psPool_t *pool, char *fileName,
				char *password, psPubKey_t **outkey);
PSPUBLIC int32 pkcs1ParsePrivbuf(psPool_t *pool, char *keyBuf, int keyBufLen, char *password,
			psPubKey_t **outkey);
#endif /* MATRIX_USE_FILE_SYSTEM */
#endif /* USE_RSA */

#ifdef MATRIX_USE_FILE_SYSTEM
PSPUBLIC int32 pkcs1DecodePrivbuf(psPool_t *pool, char *keyBuf, int32 keyBufLen, char *password,
...
*/
PSPUBLIC int32 psX509ParseCertArray(psPool_t *pool, char *certarray, int32 certarraylen,
