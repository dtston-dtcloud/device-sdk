...
int At_RadioRFBGain(stParam *param);
int At_RadioRFGNGain(stParam *param);
int At_RadioRFIQPhase(stParam *param);
int At_RadioRFIQAmp(stParam *param);
...
int At_RadioRFTempcsHT(stParam *param);
int At_RadioRFTempcsRT(stParam *param);
int At_RadioRFTempcsLT(stParam *param);
int At_RadioRFReadTempcs(stParam *param);
int At_RadioRFEnableTCSR(stParam *param);
int At_RadioRFDump(stParam *param);
int At_RadioRFSetHT(stParam *param);
int At_RadioRFSetRT(stParam *param);
int At_RadioRFSetLT(stParam *param);
int At_RadioRFLDO(stParam *param);
int At_RadioRFPA1(stParam *param);
int At_RadioRFPA2(stParam *param);
int At_RadioRFPA3(stParam *param);
int At_RadioRFXTAL(stParam *param);
int At_RadioRFFlashXTAL(stParam *param);
int At_RadioRFTempBoundary(stParam *param);
int At_RadioRFSingle(stParam *param);

int At_RadioWriteMAC(stParam *param);
int At_RadioReadMAC(stParam *param);
int At_RadioWriteSerial(stParam *param);
int At_RadioReadSerial(stParam *param);
int At_RadioRFRegisterDump(stParam *param);
int At_RadioPHYRegisterDump(stParam *param);
int At_RadioSelfCheck(stParam *param);
...
int RFIQPhase(S8 value, BOOL bWriteFlash);
int RFIQAmp(S8 value, BOOL bWriteFlash);
int RFStop();
int RFReset();
int RFCount(U8 mode, U32 *pCount, U32 *pCrc);
