...
void drv_pwm_init(PWM_ID id);
void drv_pwm_setduty(PWM_ID id, U32 dutycycle);
void drv_pwm_enable(PWM_ID id);
void drv_pwm_deinit(PWM_ID id);
void drv_pwm_disable(PWM_ID id);
#else
void drv_pwm_init();
