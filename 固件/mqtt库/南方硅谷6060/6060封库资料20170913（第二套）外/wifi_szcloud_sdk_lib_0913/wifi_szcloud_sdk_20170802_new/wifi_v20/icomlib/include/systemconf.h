...
//#define ENABLE_4STA_USE_HW_WPA2
...
U8 get_slink_mode();		// added by qinjiangwei 2017/5/9
...
*时长超过10秒后，值为1
*/
extern int gKeyLedMode;
extern void gConf_set_key_led_mode(int mode);
extern int gConf_get_key_led_mode(void);
